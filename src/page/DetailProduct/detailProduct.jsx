...
function Person() {
    ...
    function changeImg(index) {
        ...
        setSrc("https://shope-b3.thaihm.online/" + listDtail[index].listImg[0])
    ...
    useEffect(() => {
        setSrc("https://shope-b3.thaihm.online/" + product.thumbnail)
    }, [product])
    return (
        <>
            <Alert 
                ...
                <div className={cx("side_img")}>
                    {listDtail.map((value, index) => {
                        return (
                            ...
                            >
                                <img src={"https://shope-b3.thaihm.online/" + value.listImg[0]} alt=""></img>
                            </button>
                        )
                    })}
                </div>
                        ...
                        <div className={cx("box_inside_Img")}>
                            {srcSide.map(function(value,index){
                                ...
                                <div key={index} className={cx("inside_Img_side")}>
                                    <img src={"https://shope-b3.thaihm.online/"+ value} alt="" />
                                </div>
                            )})}

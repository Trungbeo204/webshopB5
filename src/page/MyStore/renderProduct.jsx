    ...
    <div className={styles.container}>
                    ...
                    <div className={styles.childProductContainerDeal}>
                        ...
                        <div className={ styles.childProduct}>
                            <div className={styles.navTitleProduct}>
                                ...
                                />
                                <img  width='80px' height='80px' src={"https://shope-b3.thaihm.online/" + value.imgP} alt="" />
        ...
        <div className={styles.payContainer}>
                            <div className={styles.topPay}>
                                <div>
                                <img  alt='' width='30px' src='https://asset.chiaki.vn/images/category/voucher.png?v=06062022'></img>
                                <p>B5 Shop Voucher</p>
                                </div>
                                <div>
                                    Chon hoặc nhập mã
